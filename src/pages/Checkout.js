...
const Checkout = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault()
        // @note API call POST to server @ /checkout sending `purchase` in body
    }

  return (
    <section className='pt-32 py-16 lg:py-40 mx-auto container'> 
    ...
    <div class="">
     ...
     {/* Total */}
      ...
      <div class="mt-6 flex items-center justify-between">
        ...
        <span className='mr-2 text-2xl font-semibold text-gray-900'></span> $ {parseFloat(total).toFixed(2)}
      </div>
    </div>
